...
// const QueueSection = ({  videosInQueue, upsetVideos applyCategoryColor, extractVideoId, calculateVideoDuration }) => {
...
// export default QueueSection;
  ...
  //   e.dataTransfer.setData("videoIndex", index); 
  // };
