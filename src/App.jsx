...
const App = () => {
  ...
  //if you want to run async code in a side effect, it needs to be wrapped in another function
  // useEffect(() => {
  ...
  //       setCurrentVideo(data.find(videoTutorial => videoTutorial.id === "1") || null);
  
  //       console.log(data.find(videoTutorial => videoTutorial.id === "1")); // Logs the user with id 1 or null
  //     } catch (error) {
  ...
  //     console.log('Updated video:', updatedVideoData);
  //   
  //   } catch (error) {
  ...
  return (
      ...
      <div className="h-screen w-screen bg-gray-800 p-5">
        <div className="grid gap-8 items-start justify-center">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-500 to-yellow-400 rounded-lg blur-opacity-75"></div>
            <button className="relative px-7 py-4 bg-gray-800 rounded-lg leading-none flex items-center divide-x divide-gray-600">
              <span className="flex items-center space-x-5">
                <span className="pr-6 text-gray-200">Words</span>
              </span>
              <span className="pl-6 text-indigo-400 group-hover:text-gray-200 transition duration-200">See What's New! 
              </span>
            </button>
...
// }
    ...
    //             <svg className="fill-current h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        //       Main
        //       <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500"> Hero Message</span>
        //       to sell yourself!
        //     </h1>
